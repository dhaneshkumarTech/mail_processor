...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<EmailService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockEmailService getAndRegisterEmailService() {
  _removeRegistrationIfExists<EmailService>();
  final service = MockEmailService();
  locator.registerSingleton<EmailService>(service);
  return service;
}
// @stacked-mock-create
